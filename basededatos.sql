...
9	moto	4000.00	2000.00	250.00	6000.00	\N	15.00	20.00	25.00	10.00	15.00	07:00:00	09:00:00	17:00:00	19:00:00	22:00:00	06:00:00	0.00	0.00	1.00	50.00	3	500.00	1	2026-01-11 01:04:22	2026-01-11 01:04:22	\N	1
...
6	11	0	0	0	0	0	0.00	0	0.00	0	0.00	2026-01-11 19:44:20.809792
8	13	9	9	0	0	0	0.00	0	0.00	0	0.00	2026-01-14 02:31:52.786436
7	1	2	2	0	0	0	0.00	0	0.00	0	0.00	2026-01-14 22:43:48.000319
\.
...
SELECT pg_catalog.setval('public.detalles_conductor_id_seq', 34, true);
...
SELECT pg_catalog.setval('public.documentos_verificacion_id_seq', 115, true);
...
SELECT pg_catalog.setval('public.empresas_metricas_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.logs_auditoria_id_seq', 158, true);
...
SELECT pg_catalog.setval('public.solicitudes_vinculacion_conductor_id_seq', 33, true);
...
SELECT pg_catalog.setval('public.user_devices_id_seq', 42, true);
...
SELECT pg_catalog.setval('public.usuarios_id_seq', 297, true);
