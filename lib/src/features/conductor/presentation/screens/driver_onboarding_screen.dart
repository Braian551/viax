...
class _DriverOnboardingScreenState extends State<DriverOnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = [
    OnboardingPage(
      ...
      description:
          'Tú decides cuándo y dónde conducir. Gestiona tus horarios con total libertad y sé tu propio jefe.',
    ),
    OnboardingPage(
      icon: Icons.account_balance_wallet_rounded,
      title: 'Gana Más',
      description:
          'Disfruta de tarifas competitivas y comisiones justas. Visualiza tus ganancias en tiempo real.',
    ),
    OnboardingPage(
      icon: Icons.verified_user_rounded,
      title: 'Seguridad Primero',
      description:
          'Viaja tranquilo con pasajeros verificados y soporte 24/7. Tu seguridad es nuestra prioridad.',
    ),
  ];
  ...
  Future<void> _completeOnboarding() async {
    ...
    await prefs.setBool('driver_onboarding_seen_v1', true);
    if (mounted) {
  ...
  Widget build(BuildContext context) {
    // Force Light theme if needed, or adapt to system. Using standard logic.
    ...
    return WillPopScope(
      // Prevent back button from bypassing onboarding
