...
/// Widget para mostrar estado vacío o de error
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Título
            Text(
              isError ? 'Error al cargar' : 'Sin viajes',
              style: TextStyle(
                color: textColor,
                fontSize: 22,
            ...
            Text(
              isError
                  ? (errorMessage ?? 'Ocurrió un error al cargar los viajes')
                  : 'No hay viajes en esta categoría.\nCompleta más viajes para verlos aquí.',
              style: TextStyle(
                color: subtitleColor,
                fontSize: 15,
                height: 1.5,
